...
$konektor = mysqli_connect("localhost","root","", "tki");
  ...
  if($ektp_hk != "") {
    ...
    $skck_baru = $angka_acak.'-'.$skck_hk;
          ...
          if(in_array($ekstensiektp, $ekstensi_diperbolehkanektp) === true)  {     
                  ...
                  // jalankan query INSERT untuk menambah data ke database pastikan sesuai urutan (id tidak perlu karena dibikin otomatis)
                    $query = "UPDATE hongkong SET sektor_hk = '$sektor_hk', ektp_hk = '$ektp_baru', kk_hk = '$kk_baru', akta_hk = '$akta_baru', suratnikah_hk = '$suratnikah_baru', suratijin_hk = '$suratijin_baru', expaspor_hk = '$expaspor_baru', skck_hk = '$skck_baru', status_proses_hk = '$status_proses_hk'";
                    $query .= "WHERE id_hongkong = '$id_hongkong'";
    ...
    $query = "UPDATE hongkong SET sektor_hk = '$sektor_hk', status_proses_hk = '$status_proses_hk'";
     $query .= "WHERE id_hongkong = '$id_hongkong'";
     $result = mysqli_query($konektor, $query);
                    // periska query apakah ada error
                    if(!$result){
