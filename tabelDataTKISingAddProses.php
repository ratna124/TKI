...
mysqli_query($konektor,"INSERT INTO singapore VALUES('','$id_dft','$sektor_sing','$kk_sing','$akte_sing','$suratnikah_sing',
                                                    '$suratijin_sing', '$expaspor_sing''$status_proses_sing')");
