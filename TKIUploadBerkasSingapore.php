...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <a href="TKIUploadBerkasSingaporeEdit.php?id_singapore=<?php echo $d['id_singapore']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card-body">
                            ...
                            <p><?php echo $d['sektor_sing']; ?></p><br>
                            </h5>E-KTP</h5>
                            <p><img src="berkas/<?php echo $d['ektp_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Kartu Keluarga</h5>
                            <p><img src="berkas/<?php echo $d['kk_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Akta Lahir</h5>
                            <p><img src="berkas/<?php echo $d['akta_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Surat Nikah</h5>
                            <p><img src="berkas/<?php echo $d['suratnikah_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Surat Ijin</h5>
                            <p><img src="berkas/<?php echo $d['suratijin_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Ex Paspor</h5>
                            <p><img src="berkas/<?php echo $d['expaspor_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>SKCK</h5>
                            <p><img src="berkas/<?php echo $d['skck_sing']; ?>" style="width: 300px;"></p><br>
                            </h5>Status Proses</h5>
                            <p><?php echo $d['status_proses_sing']; ?></p>
                        <?php 
                        }
                    ?>
